...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll' action="">
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-18 shadow-rounded'>
        ...
        <input type="text" placeholder='Type here' required className='w-full max-w-lg mt-2 p-2 border border-gray-300 rounded outline-none' 
        ...
        <select onChange={e=> setCategory(e.target.value)} name="category" className='mt-6 px-3 py-2 text-gray-500 border border-gray-300 outline-none rounded'>
