...
const Navbar = () => {
  ...
  return (
    ...
    <button onClick={() => navigate('/admin')} className="flex items-center bg-indigo-600 hover:bg-indigo-700 text-white gap-2 rounded-full font-medium w-32 h-12 py-3 px-8 my-0">Login
