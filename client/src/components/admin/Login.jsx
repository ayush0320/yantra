...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center h-screen'>
      <div className='w-full max-w-sm p-6 max-md:m-6 border border-blue-200 shadow-xl rounded-lg shadowblue-200'>
        <div className='flex flex-col items-center justify-center'>
           <div className='w-full py-6 text-center'>
              <h1 className='text-3xl font-bold'>
              <span className="text-blue-700" >Admin</span> Login</h1>
           ...
           <form onSubmit={handleSbumit} className='mt-6 w-full sm:max-w-md text-gray-800'>
            ...
            <button type='submit' className='w-full py-3 font-medium bg-indigo-500
             text-white rounded cursor-pointer hover:bg-indigo-600 transition-all'>Login</button>
           </form>
        </div>
      </div>
    </div>
